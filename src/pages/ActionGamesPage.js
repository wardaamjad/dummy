...
import icon from "../assets/r-action.png";
import { useTheme } from "@mui/material/styles";
import image from "../assets/actiongamecard.png";
import bgimage from "../assets/actionbg.png";
...
const ActionGamesPage = () => {
  ...
  const gameName = "Action Games";
  const gameCards = [
    {
      icon: image,
      name: "Action Slots Game 1",
      description: "Lorem ipsum dolor sit amet...",
    },
    {
      icon: image,
      name: "Action Slots Game 2",
      description: "Lorem ipsum dolor sit amet...",
    },
    {
      icon: image,
      name: "Action Slots Game 3",
      description: "Lorem ipsum dolor sit amet...",
    },
    ...
    <>
      ...
      <Grid
        ...
        sx={{
          ...
          padding: "6rem 3rem",
          background:  theme.palette.gradients.actionBodyGradiant,
        }}
      >
