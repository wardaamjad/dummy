...
import icon from "../assets/casino.png";
import { useTheme } from "@mui/material/styles";
import image from "../assets/WZM-GLOBALRELEASE-TOUT 1.png";
import bgimage from "../assets/Rectangle236.png";
...
const CasinoGamesPage = () => {
  ...
  const gameName = "Casino Games";
  const gameCards = [
    {
      icon: image,
      name: "Casino Slots Game 1",
      description: "Lorem ipsum dolor sit amet...",
    },
    {
      icon: image,
      name: "Casino Slots Game 2",
      description: "Lorem ipsum dolor sit amet...",
    },
    {
      icon: image,
      name: "Casino Slots Game 3",
      description: "Lorem ipsum dolor sit amet...",
    },
    ...
    <>
      ...
      <Grid
        ...
        sx={{
          ...
          padding: "6rem 3rem",
          background: theme.palette.gradients.casinoBodyGradiant,
        }}
      >
