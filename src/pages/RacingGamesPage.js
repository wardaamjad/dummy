...
import icon from "../assets/r-racing.png";
import { useTheme } from "@mui/material/styles";
import image from "../assets/racinggamecard.png";
import bgimage from "../assets/racingbg.png";
...
const RacingGamesPage = () => {
  ...
  const gameName = "Racing Games";
  const gameCards = [
    {
      icon: image,
      name: "Racing Slots Game 1",
      description: "Lorem ipsum dolor sit amet...",
    },
    {
      icon: image,
      name: "Racing Slots Game 2",
      description: "Lorem ipsum dolor sit amet...",
    },
    {
      icon: image,
      name: "Racing Slots Game 3",
      description: "Lorem ipsum dolor sit amet...",
    },
    ...
    <>
      ...
      <Grid
        ...
        sx={{
          ...
          padding: "6rem 3rem",
          background: theme.palette.gradients.racingBodyGradiant,
        }}
      >
