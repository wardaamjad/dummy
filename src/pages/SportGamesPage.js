...
import icon from "../assets/r-sport.png";
import { useTheme } from "@mui/material/styles";
import image from "../assets/sportgamecard.png";
import bgimage from "../assets/sportbg.png";
...
const SportGamesPage = () => {
  ...
  const gameName = "Sport Games";
  const gameCards = [
    {
      icon: image,
      name: "Sport Slots Game 1",
      description: "Lorem ipsum dolor sit amet...",
    },
    {
      icon: image,
      name: "Sport Slots Game 2",
      description: "Lorem ipsum dolor sit amet...",
    },
    {
      icon: image,
      name: "Sport Slots Game 3",
      description: "Lorem ipsum dolor sit amet...",
    },
    ...
    <>
      ...
      <Grid
        ...
        sx={{
          ...
          padding: "6rem 3rem",
          background: theme.palette.gradients.sportsBodyGradiant,
        }}
      >
